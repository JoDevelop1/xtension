...
The Chrome Web Store package cannot install or execute desktop CLIs by itself. To use Codex, Grok, Gemini, or Claude from Xtension, the user installs the signed bridge service. Maintainers can also run the bridge from source:
...
Maintainers can build the Windows bridge executable, the Windows service host, and signed release components with:
...
- `http://localhost/*`, `http://127.0.0.1/*`: connect to Xtension Bridge running on the user's computer.

...
End users do not need Node.js, Python, or Pillow. They can install Xtension from the Chrome Web Store or from a release archive.

To rebuild the browser packages locally, only Node.js is required:
...
Python and Pillow are only needed when regenerating the committed icons and promotional images:
